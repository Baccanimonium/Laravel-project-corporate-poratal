<div id="content-single" class="content group">
    ...
    <div id="comments">
        ...
        <ol class="commentlist group" id="comment-list-group">
        ...
        <div id="respond">
            ...
            <form action="{{ route('comment.store') }}" method="post" id="commentform">
                ...
                <p class="comment-form-author"><label for="author">{{ Lang::get('ru.form_name') }}</label> <input id="name" name="name" type="text" value="" size="30" aria-required="true" /></p>
                <p class="comment-form-email"><label for="email">{{ Lang::get('ru.form_email') }}</label> <input id="email" name="mail" type="text" value="" size="30" aria-required="true" /></p>
                <p class="comment-form-url"><label for="url">{{ Lang::get('ru.form_website') }}</label><input id="url" name="site" type="text" value="" size="30" /></p>
                @endif
                <p class="comment-form-comment"><label for="comment">{{ Lang::get('ru.form_your_comment') }}</label><textarea id="comment" name="text" cols="45" rows="8"></textarea></p>
                <div class="clear"></div>
                <p class="form-submit">
                    {{ csrf_field() }}
