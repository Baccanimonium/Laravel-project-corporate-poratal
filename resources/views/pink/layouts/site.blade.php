    ...
    <div id="wrapper" class="group">
        ...
        <div id="page-meta">
            <div class="inner group">
                <h3>{{ Lang::get('ru.welcome_to_portfolio_page') }}</h3>
                <h4>{{ Lang::get('ru.text_for_welcome_portfolio_page') }}</h4>
                {{--Welcome to my portfolio page |... i hope you enjoy my works--}}
            </div>
        </div>
        @endif
        @if(Route::currentRouteName() == 'contacts')
            <div id="page-meta">
                <div class="inner group">
                    <h3>{{ Lang::get('ru.welcome_to_contacts_page') }}</h3>
                    <h4>{{ Lang::get('ru.text_for_welcome_contacts_page') }}</h4>
                    {{--...Say Hello! :) | Get in touch with Pink Rio team--}}
                </div>
            </div>
    @endif
        <!-- START PRIMARY -->
